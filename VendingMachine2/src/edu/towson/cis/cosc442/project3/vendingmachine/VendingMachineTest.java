 ...
 *
 * @generatedBy CodePro at 3/1/18 10:46 PM
 * @author Taylor
...
public class VendingMachineTest {
	...
	public void testAddItem_2()
		...
		fixture.addItem(item, "C");
		fixture.addItem(item, "D");
	...
	public void testAddItem_4()
		...
		VendingMachine fixture = new VendingMachine();
		fixture.balance = 1.0;
		VendingMachineItem item = new VendingMachineItem("t1", 1.0);
		VendingMachineItem item2 = new VendingMachineItem("t2", 1.0);
		String code = "A";
	...
	public void testMakePurchase_5()
		throws Exception {
		VendingMachine fixture = new VendingMachine();
		VendingMachineItem item = new VendingMachineItem("test", 1.0);
		fixture.balance = 1.0;
